...
#include <image_transport/image_transport.hpp>  // modify for Ubuntu24.04
...
#include <tf2_geometry_msgs/tf2_geometry_msgs.hpp> // modify for Ubuntu24.04
...
#include <cv_bridge/cv_bridge.hpp>  // modify for Ubuntu24.04
